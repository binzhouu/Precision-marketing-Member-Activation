...
drop table if exists bimining.member_churn_mkt_predict_001;
create table bimining.member_churn_mkt_predict_001 stored as orc as
...
------------------------------step 2 行为特征汇总---------------------	
drop table if exists bimining.member_churn_visit_feature_pre_mkt;
create table bimining.member_churn_visit_feature_pre_mkt stored as orc as
select member_id,
...
drop table if exists bimining.member_churn_clct_feature_pre_mkt;
create table bimining.member_churn_clct_feature_pre_mkt stored as orc as
select cust_num,
...
drop table if exists bimining.member_churn_cart_feature_pre_mkt;
create table bimining.member_churn_cart_feature_pre_mkt stored as orc as
select member_id,
...
drop table if exists bimining.member_churn_pruchase_feature_pre_mkt;
create table bimining.member_churn_pruchase_feature_pre_mkt stored as orc as
select member_id,
...
drop table if exists bimining.member_churn_mkt_pre_w;
create table bimining.member_churn_mkt_pre_w stored as orc as
select t1.member_id,
		t2.gender,
		t2.age_value,
...
from bimining.member_churn_mkt_predict_001 t1
...
left join bimining.member_churn_visit_feature_pre_mkt t4
on t1.member_id=t4.member_id 
left join bimining.member_churn_clct_feature_pre_mkt t5
on t1.member_id=t5.cust_num 
left join bimining.member_churn_cart_feature_pre_mkt t6
on t1.member_id=t6.member_id 
left join bimining.member_churn_pruchase_feature_pre_mkt t7
