...
drop table if exists bimining.member_churn_muying_twice_train_w;
create table bimining.member_churn_muying_twice_train_w stored as orc as
select t1.member_id,
        t1.whether_churn,
		t2.gender,
		t2.age_value,
...
from bimining.member_churn_muying_twice_lose_label t1
