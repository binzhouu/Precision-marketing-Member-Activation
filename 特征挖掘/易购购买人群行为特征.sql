...
drop table if exists bimining.member_churn_visit_feature_yigou;
create table bimining.member_churn_visit_feature_yigou stored as orc as
select member_id,
...
drop table if exists bimining.member_churn_clct_feature_yigou;
create table bimining.member_churn_clct_feature_yigou stored as orc as
select cust_num,
...
drop table if exists bimining.member_churn_cart_feature_yigou;
create table bimining.member_churn_cart_feature_yigou stored as orc as
select member_id,
...
drop table if exists bimining.member_churn_pruchase_feature_yigou;
create table bimining.member_churn_pruchase_feature_yigou stored as orc as
select member_id,
...
drop table if exists bimining.member_churn_yigou_train_w;
create table bimining.member_churn_yigou_train_w stored as orc as
select t1.member_id,
        t1.whether_churn,
		t2.gender,
		t2.age_value,
...
from bimining.member_churn_yigou_lose_label t1
...
left join bimining.member_churn_visit_feature_yigou t4
on t1.member_id=t4.member_id 
left join bimining.member_churn_clct_feature_yigou t5
on t1.member_id=t5.cust_num 
left join bimining.member_churn_cart_feature_yigou t6
on t1.member_id=t6.member_id 
left join bimining.member_churn_pruchase_feature_yigou t7
