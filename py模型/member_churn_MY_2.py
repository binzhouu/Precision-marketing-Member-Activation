...
train_set_path = 'E:\\ZB\\Bayes\\MY2_train.csv'
...
df = df.drop(['member_churn_muying_twice_train_w.child_age','member_churn_muying_twice_train_w.reliability_score_age'],axis=1)
...
featStart_Idx = cols_train.index('member_churn_muying_twice_train_w.visit_amnt_1y')
featEnd_Idx = cols_train.index('member_churn_muying_twice_train_w.gds_cmnt_1w')
label = 'member_churn_muying_twice_train_w.whether_churn'
...
gender_arr_train = np.array(trainDF.loc[:,'member_churn_muying_twice_train_w.gender'])
gender_arr_test = np.array(testDF.loc[:,'member_churn_muying_twice_train_w.gender'])
...
label_encoder = preprocessing.LabelEncoder()
level_arr_train = np.array(trainDF.loc[:,'member_churn_muying_twice_train_w.cust_level_num'])
level_arr_test = np.array(testDF.loc[:,'member_churn_muying_twice_train_w.cust_level_num'])
...
label_encoder = preprocessing.LabelEncoder()
purchase_arr_train = np.array(trainDF.loc[:,'member_churn_muying_twice_train_w.purchase_power'])
purchase_arr_test = np.array(testDF.loc[:,'member_churn_muying_twice_train_w.purchase_power'])
...
label_encoder = preprocessing.LabelEncoder()
loyalty_arr_train = np.array(trainDF.loc[:,'member_churn_muying_twice_train_w.loyalty_level'])
loyalty_arr_test = np.array(testDF.loc[:,'member_churn_muying_twice_train_w.loyalty_level'])
...
label_encoder = preprocessing.LabelEncoder()
scor_arr_train = np.array(trainDF.loc[:,'member_churn_muying_twice_train_w.scor_label'])
scor_arr_test = np.array(testDF.loc[:,'member_churn_muying_twice_train_w.scor_label'])
...
label_encoder = preprocessing.LabelEncoder()
reliability_arr_train = np.array(trainDF.loc[:,'member_churn_muying_twice_train_w.reliability_grade_age'])
reliability_arr_test = np.array(testDF.loc[:,'member_churn_muying_twice_train_w.reliability_grade_age'])
...
label_encoder = preprocessing.LabelEncoder()
accur_arr_train = np.array(trainDF.loc[:,'member_churn_muying_twice_train_w.accur_grade_age'])
accur_arr_test = np.array(testDF.loc[:,'member_churn_muying_twice_train_w.accur_grade_age'])
...
print(datetime.now().strftime('%Y-%m-%D %H-%M-%S') + ' naive_bayes End...')
